...
public class Listeners extends base implements ITestListener {
	...
	ExtentTest test;
	ThreadLocal<ExtentTest> extentTest = new ThreadLocal<ExtentTest>(); //class to make parallel tests thread-safe
	...
	public void onTestFailure(ITestResult result) {
		extentTest.get().fail(result.getThrowable()); //retrieving failure log
